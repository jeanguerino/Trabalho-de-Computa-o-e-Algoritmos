	# Algoritmo: Gramática livre de contexto para Forma Normal de Chomsky (CFG para NCF)
	...
	# Remove regras longas (mais que dois estados a direita ex.: A->BCD)
	def longo(regras,let,voc):
	

	    # Cópia do dicionário (com tamanho dinâmico durante processo)
	    ...
	    for key in new_dict:
	        ...
	        for i in range(len(values)):
	            ...
	            # verificando se há violação de regra
	            if len(values[i]) > 2:
